...
st.image("images/image4.png", use_column_width=False, width=400)
...
st.image("images/image5.png", use_column_width=False, width=400)
...
st.image("images/image6.png", use_column_width=False, width=400)

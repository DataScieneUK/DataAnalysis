...
st.image("images/image4.png",  use_container_width=True, width=100)
...
st.image("images/image5.png",  use_container_width=True, width=100)
...
st.image("images/image6.png",  use_container_width=True, width=100)

...
st.image("images/image1.png", use_container_width =False, width=400)
...
st.image("images/image2.png", use_container_width =False, width=400)
...
st.image("images/Image3.png", use_container_width =False, width=400)
